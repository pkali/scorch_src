...
;-------------------------------------
COLPM0S = $02C0 ;- - rejestr-cieñ COLPM0
COLPM1S = $02C1 ;- - rejestr-cieñ COLPM1
COLPM2S = $02C2 ;- - rejestr-cieñ COLPM2
COLPM3S = $02C3 ;- - rejestr-cieñ COLPM3
...
COLBAKS = $02C8
GTICTLS = $026F ;- - rejestr-cieñ GTIACTL

DMACTLS = $022F ;- - rejestr kontroli dostêpu do pamiêci - cieñ
DLPTRS  = $0230 ;- - adres programu ANTIC-a - cieñ
CHBAS   = $02F4 ;- - rejestr-cieñ CHBASE
KBCODES = $02FC ;- - rejestr-cieñ KBCODE
...
MEMTOP  =   $02E5 ;- - adres górnej granicy wolnej pamiêci RAM
MEMLO   =   $02E7 ;- - adres dolnej granicy wolnej pamiêci RAM
...
TRIG0S  = $0284 ;- TRIG0S - przycisk joysticka 0, rejestr-cieñ TRIG0
TRIG1S  = $0285 ;- TRIG1S - przycisk joysticka 1, rejestr-cieñ TRIG1
TRIG2S  = $0286 ;- TRIG2S - rejestr-cieñ TRIG0
TRIG3S  = $0287 ;- TRIG3S - rejestr-cieñ TRIG1


/*
Rejestry OS w pamiêci RAM

  $08 - WARMST - znacznik gor¹cego startu
  $0E - APPMHI - najwy¿szy adres RAM zajêty przez program
  $10 - IRQENS - rejestr-cieñ IRQEN
  $11 - IRQSTAT - rejestr-cieñ IRQST
  $12 - RTCLOK - zegar czasu rzeczywistego
  $15 - BUFADR - adres bufora dla operacji dyskowych
  $17 - ICCOMT - rejestr przejœciowy kodu operacji I/O
  $20 - ZIOCB - zerostronicowy blok kontroli I/O
  $20 - ICHIDZ - indeks wpisu urz¹dzenia w HATABS
  $21 - ICDNOZ - numer urz¹dzenia
  $22 - ICCOMZ - kod operacji wejœcia/wyjœcia
  $23 - ICSTZ - status operacji wejœcia/wyjœcia
  $24 - ICBAZ - adres bufora danych dla operacji I/O
  $26 - ICPTZ - adres procedury obs³ugi dla operacji
  $28 - ICBLZ - d³ugoœæ bufora danych dla operacji I/O
  ...
  $34 - BUFEN - adres koñca bufora danych dla SIO
  $36 - LTEMP - pomocniczy wektor odczytu listy liniowej
  $38 - BUFRFL - znacznik zape³nienia bufora SIO
  $39 - RECVND - znacznik koñca odczytu
  $3A - XMTDON - znacznik koñca transmisji
  $3B - CHKSNT - znacznik nadania sumy kontrolnej
  $3C - NOCKSM - znacznik braku sumy kontrolnej
  $3D - BPTR - licznik bufora magnetofonu
  $3E - GAPTYP - znacznik d³ugoœci przerwy miêdzy blokami
  $3F - FEOF - znacznik koñca zbioru
  $40 - FREQ - licznik dŸwiêku przy otwarciu magnetofonu
  $41 - IOSNDEN - znacznik dŸwiêku przy transmisji
  $42 - CRITIC - znacznik krytycznych czasowo operacji I/O
  $4A - ZCHAIN - rejestr nastêpstwa listy liniowej
  $4C - DSTAT - status klawiatury i ekranu
  $50 - TEMP - pomocniczy rejestr przejœciowy
  $51 - HOLD1 - pomocniczy rejestr przejœciowy
  ...
  $58 - SAVMSC - adres pamiêci obrazu
  ...
  $7C - HOLDCH - przechowywanie wartoœci znaku
  $7D - INSDAT - rejestr pomocniczy edytora
  $7E - COUNTR - licznik pamiêci obrazu dla DOSCR i DRAW
...
$022F - DMACTLS - rejestr-cieñ DMACTL
$0230 - DLPTRS - rejestr-cieñ DLPTR
$0232 - SKCTLS - rejestr-cieñ SKCTL
$0233 - LCOUNT - licznik odczytu dla nowego urz¹dzenia
$0234 - LPENHS - rejestr-cieñ LPENH
$0235 - LPENVS - rejestr-cieñ LPENV
...
$023F - ERRFLG - znacznik b³êdu operacji SIO
$0244 - COLDST - znacznik zimnego startu systemu
$0245 - RECLEN - d³ugoœæ rekordu z nowego urz¹dzenia
$0246 - DSKTIM - wartoœæ Timeout dla stacji dysków
$0247 - PDVMSK - maska obecnoœci nowych urz¹dzeñ
$0248 - PDVRS - rejestr-cieñ PDVREG
$024A - RELADR - adres procedury przemieszczalnej
$024C - PPTMPA - rejestr przechowania zawartoœci akumulatora
$024D - PPTMPX - rejestr przechowania zawartoœci rejestru X
$026B - CHSPTR - wektor nieu¿ywanego zestawu znaków
$026C - VSFLAG - znacznik przesuwu pionowego obrazu
$026E - FINE - znacznik delikatnego przesuwu obrazu
$026F - GTICTLS - rejestr-cieñ GTIACTL
$0270 - PADDL0 - rejestr-cieñ POT0
...
$0284 - TRIG0S - przycisk joysticka 0, rejestr-cieñ TRIG0
$0285 - TRIG1S - przycisk joysticka 1, rejestr-cieñ TRIG1
$0286 - TRIG2S - rejestr-cieñ TRIG0
$0287 - TRIG3S - rejestr-cieñ TRIG1
$0288 - HIBYTE - indeks operacji nowego urz¹dzenia
$0289 - WMODE - znacznik sposobu dostêpu do magnetofonu
$028A - BLIM - d³ugoœæ bufora magnetofonu
...
$0294 - TXTMSC - adres pamiêci okna tekstowego
$029C - CRETRY - liczba powtórzeñ rozkazu operacji
$029D - HOLD3 - pomocniczy rejestr przejœciowy
$029E - SUBTMP - pomocniczy rejestr przejœciowy
...
$02BC - HOLD4 - pomocniczy rejestr przejœciowy
$02BD - DRETRY - liczba powtórzeñ wywo³añ urz¹dzenia
$02BE - SHFLOK - znacznik klawiszy SHIFT i CONTROL
$02BF - BOTSCR - liczba wierszy tekstu
$02C0 - COLPM0S - rejestr-cieñ COLPM0
$02C1 - COLPM1S - rejestr-cieñ COLPM1
$02C2 - COLPM2S - rejestr-cieñ COLPM2
$02C3 - COLPM3S - rejestr-cieñ COLPM3
$02C4 - COLPF0S - rejestr-cieñ COLPF0
$02C5 - COLPF1S - rejestr-cieñ COLPF1 ;gr.8 letters
$02C6 - COLPF2S - rejestr-cieñ COLPF2 ;gr.8 background
$02C7 - COLPF3S - rejestr-cieñ COLPF3
$02C8 - COLBAKS - rejestr-cieñ COLBAK
$02C9 - RUNADR - adres procedury nowego urz¹dzenia
$02CB - HIUSED - adres koñcowy procedury nowego urz¹dzenia
...
$02D5 - DSCTLN - d³ugoœæ sektora dyskowego
$02DB - NOCLIK - znacznik dŸwiêku klawiatury
$02DE - PBPNT - licznik bufora drukarki
$02DF - PBUFSZ - d³ugoœæ bufora drukarki
$02E5 - MEMTOP - adres górnej granicy wolnej pamiêci RAM
$02E7 - MEMLO - adres dolnej granicy wolnej pamiêci RAM
...
$02EE - CBAUD - prêdkoœæ transmisji z magnetofonu
$02F0 - CRSINH - znacznik widocznoœci kursora
$02F3 - CHACT - rejestr-cieñ CHRCTL
$02F4 - CHBAS - rejestr-cieñ CHBASE
...
$02FA - CHAR - kod wewnêtrzny znaku
$02FB - ATACHR - kod ATASCII znaku
$02FC - KBCODES - rejestr-cieñ KBCODE
$02FD - FILDAT - numer koloru dla wype³niania
$02FE - DSPFLG - znacznik wyœwietlania znaków kontrolnych
...
$0306 - DTIMLO - wartoœæ Timeout dla urz¹dzenia
$0308 - DBYT - d³ugoœæ bufora danych
...
$0312 - TEMP1 - pomocniczy rejestr przejœciowy
$0313 - TEMP2 - pomocniczy rejestr przejœciowy
$0314 - PTIMOT - wartoœæ Timeout dla drukarki
$0315 - TEMP3 - pomocniczy rejestr przejœciowy
$0316 - SAVIO - rejestr przejœciowy dla operacji SIO
$0317 - TIMFLG - znacznik up³yniêcia czasu Timeout
$0318 - STACKP - rejestr wskaŸnika stosu dla SIO
$0319 - TSTAT - przejœciowy rejestr statusu SIO
$031A - HATABS - tabela wektorów procedur obs³ugi
...
$0348 - ICBUFL - d³ugoœæ bufora danych dla operacji I/O
...
$03EC - DERRF - znacznik b³êdu przy otwieraniu edytora
$03FB - CHLINK  - rejestr elementów listy liniowej
$03FD - CSCB - bajty kontroli szybkoœci magnetofonu
$03FF - CRCB - bajt d³ugoœci rekordu magnetofonowego
...
$D01C - VDELAY - licznik opóŸnienia pionowego P/MG
...
$D200 - AUDF1 - czêstotliwoœæ pracy generatora 1 (Z)
$D200 - POT0 - rejestr po³o¿enia potencjometru 0 (O)
$D201 - AUDC1 - rejestr kontroli dŸwiêku generatora 1 (Z)
$D201 - POT1 - rejestr po³o¿enia potencjometru 1 (O)
$D202 - AUDF2 - czêstotliwoœæ pracy generatora 2 (Z)
$D202 - POT2 - rejestr po³o¿enia potencjometru 2 (O)
$D203 - AUDC2 - rejestr kontroli dŸwiêku generatora 2 (Z)
$D203 - POT3 - rejestr po³o¿enia potencjometru 3 (O)
$D204 - AUDF3 - czêstotliwoœæ pracy generatora 3 (Z)
$D205 - AUDC3 - rejestr kontroli dŸwiêku generatora 3 (Z)
$D206 - AUDF4 - czêstotliwoœæ pracy generatora 4 (Z)
$D207 - AUDC4 - rejestr kontroli dŸwiêku generatora 4 (Z)
$D208 - AUDCTL - rejestr kontroli generatorów dŸwiêku (Z)
$D208 - POTST - status odczytu potencjometrów (O)
$D209 - STIMER - rejestr zerowania liczników (Z)
$D209 - KBCODE - kod ostatnio naciœniêtego klawisza (O)
...
$D20D - SEROUT - szeregowy rejestr wyjœciowy (Z)
$D20D - SERIN - szeregowy rejestr wejœciowy (O)
$D20E - IRQEN - zezwolenia przerwañ IRQ (Z)
$D20E - IRQST - status przerwañ IRQ (O)
...
$D400 - DMACTL - rejestr kontroli dostêpu do pamiêci
$D401 - CHRCTL - rejestr kontroli wyœwietlania znaków
...
$D407 - PMBASE - adres pamiêci graczy i pocisków
$D409 - CHBASE - adres zestawu znaków
$D40A - WSYNC - znacznik oczekiwania na synchronizacjê poziom¹
$D40B - VCOUNT - licznik linii obrazu
$D40C - LPENH - poziome po³o¿enie pióra œwietlengo
$D40D - LPENV - pionowe po³o¿enie pióra œwietlnego
$D40E - NMIEN - rejestr zezwoleñ na przerwania NMI
$D40F - NMIST - rejestr statusu przerwañ NMI
*/
